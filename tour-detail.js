...
function renderMeetingPointSection(meetingPoint) {
  ...
  if (meetingPoint.disclaimerHtml !== undefined && meetingPoint.disclaimerHtml !== null) {
    ...
    disclaimerHtml = '<p style="text-align: center">' +
      ...
      'An additional fee applies for Boston Flynn Cruiseport. ' +
      'Pickup is not available at Boston Logan International Airport. ' +
      'We may be able to accommodate pickups outside this area for an extra fee. ' +
